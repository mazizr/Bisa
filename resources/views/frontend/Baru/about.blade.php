        ...
        <div class="row">
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              ...
              <img src="{{asset('assets/frontend/baru-template/images/person_1.jpg')}}" alt="" class="img-fluid mb-3">
          ...
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              ...
              <img src="{{asset('assets/frontend/baru-template/images/person_3.jpg')}}" alt="" class="img-fluid mb-3">
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
            </div>
          </div>
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              ...
              <img src="{{asset('assets/frontend/baru-template/images/person_2.jpg')}}" alt="" class="img-fluid mb-3">
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
            </div>
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item text-center">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(assets/frontend/baru-template/images/person_1.jpg)">
              ...
              <div class="item text-center">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(assets/frontend/baru-template/images/person_2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item text-center">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(assets/frontend/baru-template/images/person_3.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
